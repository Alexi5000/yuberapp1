...
// description: Auth-gated dashboard shell with resizable sidebar navigation
// reference: client/src/components/ui/sidebar.tsx, client/src/_core/hooks/useAuth.ts
'use client';
...
type MenuItem = { icon: typeof LayoutDashboard | typeof Users, label: string, path: '/' | '/some-path' };
const menuItems: MenuItem[] = [{ icon: LayoutDashboard, label: 'Page 1', path: '/' }, { icon: Users, label: 'Page 2', path: '/some-path' }];
...
function DashboardLayoutContent({ children, setSidebarWidth }: DashboardLayoutContentProps) {
  ...
  const navigate = (href: MenuItem['path']) => router.push(href as Parameters<typeof router.push>[0]);
