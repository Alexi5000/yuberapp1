...
// description: Responsive sidebar layout with mobile/offcanvas behavior
// reference: client/src/components/ui/sheet.tsx, client/src/hooks/useMobile.tsx
'use client';
...
function SidebarProvider(
  { defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }: React.ComponentProps<'div'> & {
    defaultOpen?: boolean,
    open?: boolean,
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          style={{ '--sidebar-width': SIDEBAR_WIDTH_MOBILE } as React.ComponentProps<typeof SheetContent>['style']}
          side={side}>
